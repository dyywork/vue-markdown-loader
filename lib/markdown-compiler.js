...
var renderVueTemplate = function(html, wrapper, opts) {
  ...
  if (opts.script) {
    var scriptStr = methodStr = createdStr = beforeCreateStr = mountedStr= beforeMountStr = ''
    var dataObj = {}
    var methodObj = {}
    ...
    scriptStr = 'export default {data() {return ' + JSON.stringify(dataObj) +'},methods:{'+ methodStr+ '},beforeCreate(){'+ beforeCreateStr +'},created(){'+ createdStr +'},beforeMount(){'+ beforeMountStr +'},mounted(){'+ mountedStr +'}}'
